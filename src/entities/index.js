...
export default { makeSession, makeHeartbeat, makeScene, makeUser, makePropBackground, makePropSound, makeProp, makeFitbit }
export { makeSession, makeHeartbeat, makeScene, makeUser, makePropBackground, makePropSound, makeProp, makeFitbit }